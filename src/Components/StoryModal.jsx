  ...
  return (
    ...
    <div className='w-full max-w-md'>
      ...
      <div className='rounded-lg h-96 flex items-center justify-center relative' style={{backgroundColor:background}}>
       ...
       <div className='flex mt-4 gap-2'>
        <button onClick={()=>{setMode('text');setMedia(null);setPreviewUrl(null)}} className={`flex-1 flex items-center justify-center gap-2 p2 rounded cursor-pointer
       ...
       <button onClick={()=>toast.promise(handleCreateStory(),
                           ...
                           hove:from-indigo-600 hover:to-purple-700 active:scale-95 transition
                            cursor-pointer'>
